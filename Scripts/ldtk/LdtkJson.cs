...
namespace Verse.ldtk
{
    ...
    public static class Serialize
    {
        ...
        public static string ToJson(this Level self) => JsonConvert.SerializeObject(self, ldtk.Converter.Settings);
    }
    
    public partial class Level 
    {
        public static Level FromJson(string json) => JsonConvert.DeserializeObject<Level>(json, ldtk.Converter.Settings);
    }
